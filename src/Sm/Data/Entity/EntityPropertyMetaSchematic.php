...
class EntityPropertyMetaSchematic implements Schematic, \JsonSerializable {
    protected $propertyContainer;
    /** @var array $primarySmIDs an array of the smIDs that we say are primary */
    protected $primarySmIDs = [];
    /** @var  array $uniqueSmIDs An array of the smIDs of Properties that are unique across this Entity. */
