...
namespace Sm\Modules\Query\Sql\Formatting\Clauses;


use Sm\Core\Exception\InvalidArgumentException;
use Sm\Modules\Query\Sql\Formatting\Clauses\Exception\IncompleteClauseException;
 ...
 *
 * @package Sm\Modules\Query\Sql\Formatting\Clause
 */
class ConditionalClauseFormatter extends SqlQueryFormatter {
     ...
     * @throws \Sm\Modules\Query\Sql\Formatting\Clauses\Exception\IncompleteClauseException
     */
