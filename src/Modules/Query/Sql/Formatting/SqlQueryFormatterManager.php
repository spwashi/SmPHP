...
use Sm\Core\Util;
use Sm\Modules\Query\Sql\Formatting\Aliasing\Exception\InvalidAliasedItem;
use Sm\Modules\Query\Sql\Formatting\Aliasing\SqlFormattingAliasContainer;
use Sm\Modules\Query\Sql\Formatting\Proxy\Aliasing\AliasedFormattingProxy;
 ...
 *
 * @package Sm\Modules\Query\Sql\Formatting
...
class SqlQueryFormatterManager {
    ...
    /**
     * @var \Sm\Modules\Query\Sql\Formatting\Aliasing\SqlFormattingAliasContainer
     */
    private $aliasContainer;
    /**
     * @var \Sm\Modules\Query\Sql\Formatting\SqlFormattingContext
     */
     ...
     * @param \Sm\Modules\Query\Sql\Formatting\Aliasing\SqlFormattingAliasContainer $aliasContainer
     *
     * @internal param \Sm\Modules\Query\Sql\Formatting\SqlFormattingContext $context
     */
    ...
    public function alias($item, string $alias_classname, $alias_name = null) {
        ...
        /** @var \Sm\Modules\Query\Sql\Formatting\Proxy\Aliasing\AliasedFormattingProxy $aliasProxy */
     ...
     *
     * @return \Sm\Modules\Query\Sql\Formatting\Aliasing\SqlFormattingAliasContainer
     */
